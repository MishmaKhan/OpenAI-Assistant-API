...
class AssistantManager:
    ...
    def create_assistant(self, name, instructions, tools):
        if not self.assistant:
            ...
            AssistantManager.assistant_id = assistant_obj.assistant.id
    ...
    def create_thread(self):
        if not self.thread:
            ...
            AssistantManager.thread_id = thread_obj.thread.id
    ...
    def run_assistant(self, instructions):
        if self.thread and self.assistant:
            self.run = self.client.beta.threads.run.create(
                thread_id=self.thread.id,
    ...
    with st.form(key="user_input_form"):
        ...
        if submit_button:
            manager.create_assistant(
                ...
                instructions="You are a personal article summarizer who knows how to take a list of articles titles and descriptions and the write a short summary of all the news articles",
                tools=[
                    {
                        "type": "function",
                        "function": {
            ...
            # Add the message and run the assistanat
            ...
            # Wait for completions and the process messages
